...
func ConnectDB() *gorm.DB {
    ...
    fmt.Println("Menghapus tabel lama (Drop Tables)...")
    err = DB.Migrator().DropTable(&User{}, &Balita{}, &Pengukuran{}, &NutrisiHarian{})
    if err != nil {
        log.Fatal("Gagal menghapus tabel lama:", err)
    }
    fmt.Println("Menjalankan Auto Migrate ulang tabel...")
    err = DB.AutoMigrate(
        &User{},
        &Balita{},
        &Pengukuran{},
    ...
    fmt.Println("Migrate:fresh berhasil! Semua tabel direset.")
